        ...
        **/
        ...
        _checkIsInstall: function(shareType, type, pCallBack) { //检查分享目标app是否下载
            ...
            if (shareType == 1 || shareType == 2) {
                destCilentFunction = api.require('wx').isInstalled;
                dyanMsg = "微信";
            }
            if (shareType == 3 || shareType == 4) {
                destCilentFunction = api.require('qq').installed;
                dyanMsg = "qq";
            }
            if (shareType == 5) {
        ...
        _auth: function(shareType, pCallback) { //登录授权
            ...
            self._checkIsInstall(shareType, "login", function(iType) {
                if (!iType) {
                    ...
                    var dyanMsg;
                    if (shareType == 1 || shareType == 2) {
                        destCilentFunction = api.require('wx').auth;
                        dyanMsg = "微信";
                    }
                    if (shareType == 3 || shareType == 4) {
                        destCilentFunction = api.require('qq').login;
                        dyanMsg = "qq";
                    }
                    if (shareType == 5) {
        ...
        _getUserInfo: function(shareType, pCallback) {
            ...
            self._auth(shareType, function(tData) {
                ...
                var _param;
                if (shareType == 1 || shareType == 2) {
                    destCilentFunction = api.require('wx').getUserInfo;
                    dyanMsg = "微信";
                    _TokenpostData = {
                ...
                if (shareType == 3 || shareType == 4) {
                    destCilentFunction = api.require('qq').getUserInfo;
                    dyanMsg = "qq";
                    _TokenpostData = "";
                    _param = {
                        accessToken: tokenData.accessToken,
