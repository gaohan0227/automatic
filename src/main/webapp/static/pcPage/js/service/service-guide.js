...
function GUIDE(path,pCallBack) {
    ...
    function fnShowStartBtn() {
        if ('[object Number]' !== Object.prototype.toString.call(_btnId)) {
            _button.open({
                rect: {
                    x: api.winWidth / 2 - 80,
                    y: api.winHeight - 70-localStorage.safeBottom,
                    w: 160,
                    h: 46
                },
                corner: 10,
                bg: {
                    normal: 'rgba(0,137,200,1)',
                    highlight: 'rgba(0,137,200,1)',
                    active: 'rgba(0,137,200,1)'
                },
                title: {
                    size: 20,
                    highlight: '立即体验',
    ...
    var _params = {
        rect: {
            ...
            y: 0,
            w: 'auto',
            h: api.winHeight-localStorage.safeBottom
        },
        data: {
            paths: _paths,
        },
