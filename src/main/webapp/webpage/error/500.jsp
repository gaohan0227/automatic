...
if (true) {//Servlets.isAjaxRequest(request)
	out.print(sb);
}
...
<%@page import="priv.bigant.web.Servlets"%>
<%@page import="priv.bigant.aotomatic.common.Exceptions"%>
<%@page import="priv.bigant.aotomatic.StringUtils"%>
