...
<meta name="author" content="http://www.liuliangqb.com/"/>
...
<link href="${ctxStatic}/jquery-select2/dist/css/select2.min.css" rel="stylesheet" />
<script src="${ctxStatic}/jquery-select2/dist/js/select2.full.min.js" type="text/javascript"></script>


<script src="${ctxStatic}/jquery-validation/1.14.0/jquery.metadata.js" type="text/javascript"></script>
<script src="${ctxStatic}/jquery-validation/1.14.0/jquery.validate.min.js" type="text/javascript"></script>
<script src="${ctxStatic}/jquery-validation/1.14.0/idcard.js" type="text/javascript"></script>
<script src="${ctxStatic}/jquery-validation/1.14.0/jquery.validate.extends.js" type="text/javascript"></script>
...
<!-- 引入layui -->
<link rel="stylesheet" href="${ctxStatic}/layui/layui.css"  media="all">
