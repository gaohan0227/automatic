...
<div class="ibox-title">
	...
	<form:form id="searchForm" action="${ctx}/sys/log/" method="post"  class="form-inline">
		...
		<div class="form-group">
			<span><spring:message code='global.operation.menu'/>：</span>
				<input id="title" name="title" type="text" maxlength="50" class="form-control input-sm" value="${log.title}"/>
			<span><spring:message code='clientUser.username'/>ID：</span>
			...
			<span><spring:message code='global.date.range'/>：&nbsp;</span>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<th class="sort-column title"><spring:message code='global.operation.menu'/></th>
		<th class="sort-column name"><spring:message code='clientUser.username'/></th>
		<th class="sort-column requestUri">URI</th>
		<th class="sort-column method"><spring:message code='sysLog.method'/></th>
		<th class="sort-column remoteAddr"><spring:message code='sysLog.remoteAddr'/></th>
		<th class="sort-column createDate"><spring:message code='sysLog.createDate'/></th>
		</tr>
		</thead>
