...
<head>
	...
	<script src="${ctxStatic}/common/contabs.js"></script> 
 	<meta name="keywords" content="LLQB快速开发平台">
    <meta name="description" content="采用spring mvc+mybatis+shiro+bootstrap，集成代码生成器的快速开发平台">
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">SjjtPlus</span>
							 &copy; 2015-2020
						</span>
