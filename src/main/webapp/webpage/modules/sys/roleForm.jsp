...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			// <spring:message code='global.refresh'/>（显示/隐藏）机构
			refreshOfficeTree();
...
<%-- 		         <td class="width-15 active"><label class="pull-right">归属机构:</label></td>
		         ...
		         <td  class="width-15" class="active"><label class="pull-right"><font color="red">*</font><spring:message code='sysRole.name'/>:</label></td>
		      ...
		      <tr>
		         <td class="width-15 active"><label class="pull-right"><font color="red">*</font><spring:message code='sysRole.enname'/>:</label></td>
		         ...
		         <td  class="width-15" class="active"><label class="pull-right"><spring:message code='sysRole.roleType'/>:</label></td>
		         <td class="width-35"><%--
		      ...
		      <tr>
		         <td class="width-15 active"><label class="pull-right"><spring:message code='sysRole.isSys'/>:</label></td>
		         <td class="width-35"><form:select path="sysData" class="input-medium">
					<form:options items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
					<span class="help-inline">“是”代表此数据只有超级管理员能进行修改，“否”则表示拥有角色<spring:message code='global.update_by'/>员的权限都能进行修改</span></td>
		         <td  class="width-15" class="active"><label class="pull-right"><spring:message code='sysRole.useable'/></label></td>
		         <td class="width-35"><form:select path="useable" class="input-medium ">
					<form:options items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
					<span class="help-inline">“是”代表此数据可用，“否”则表示此数据不可用</span></td>
		      </tr>
		      <tr>
		         <td class="width-15 active"><label class="pull-right"><spring:message code='sysRole.dataScope'/>:</label></td>
		         <td class="width-35"><form:select path="dataScope" class="input-medium ">
				 ...
				 <td class="width-15 active"><label class="pull-right"><spring:message code='sysRole.remarks'/>:</label></td>
