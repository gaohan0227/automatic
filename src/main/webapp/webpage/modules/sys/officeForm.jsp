		   ...
		   <tbody>
		      <tr>
		       ...
		       <tr>
		         ...
		         <td class="width-35"><form:select path="type" class="input-medium">
					<form:options items="${fns:getDictList('sys_office_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select></td>
		         <td  class="width-15"  class="active"><label class="pull-right">机构级别:</label></td>
		         <td class="width-35"><form:select path="grade" class="input-medium">
		      ...
		      <tr>
		         <td class="width-15 active"><label class="pull-right"><spring:message code='sysUser.phone'/>:</label></td>
		      ...
		      <tr>
		         <td class="width-15 active"><label class="pull-right"><spring:message code='sysOffice.email'/>:</label></td>
