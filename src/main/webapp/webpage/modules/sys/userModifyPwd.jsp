...
<body>
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/modifyPwd"  method="post" class="form-horizontal form-group">
		...
		<div class="control-group">
			<label class="col-sm-3 control-label"><font color="red">*</font><spring:message code="global.oldPwd"></spring:message>:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="col-sm-3 control-label"><font color="red">*</font><spring:message code="global.newPwd"></spring:message>:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><font color="red">*</font><spring:message code="global.confirm.newPwd"></spring:message>:</label>
			<div class="controls">
