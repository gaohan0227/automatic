...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="statisticsConfig" action="${ctx}/statisticsconfig/statisticsConfig/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<form:input path="cKey" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">值：</label></td>
					<td class="width-35">
						<form:input path="cValue" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">标识：</label></td>
					<td class="width-35">
						<form:input path="cType" htmlEscape="false"    class="form-control "/>
					</td>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">排序（升序）：</label></td>
					<td class="width-35">
