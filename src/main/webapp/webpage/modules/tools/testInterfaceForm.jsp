...
<body class="hideScroll">
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">成功时返回<spring:message code='inationGlobal.title'/> ：</label></td>
					<td class="width-35">
						<form:input path="successmsg" htmlEscape="false" maxlength="512" class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">失败时返回<spring:message code='inationGlobal.title'/> ：</label></td>
					<td class="width-35">
