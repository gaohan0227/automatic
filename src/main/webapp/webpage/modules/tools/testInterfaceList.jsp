	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<th  width="110px" class="nowrap sort-column successmsg">成功时返回<spring:message code='inationGlobal.title'/> </th>
				<th  width="110px" class="nowrap sort-column errormsg">失败时返回<spring:message code='inationGlobal.title'/> </th>
				<th  class="nowrap sort-column remarks">备注</th>
				<th  width="210px"><spring:message code='global.opt'/> </th>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<shiro:hasPermission name="tools:testInterface:view">
						<a href="#" onclick="openDialogView('查看接口', '${ctx}/tools/testInterface/form?id=${testInterface.id}','800px', '500px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> <spring:message code='global.view'/></a>
					</shiro:hasPermission>
					<shiro:hasPermission name="tools:testInterface:edit">
    					<a href="#" onclick="openDialog('修改接口', '${ctx}/tools/testInterface/form?id=${testInterface.id}','800px', '500px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> <spring:message code='global.update'/></a>
    				</shiro:hasPermission>
    				<shiro:hasPermission name="tools:testInterface:del">
						<a href="${ctx}/tools/testInterface/delete?id=${testInterface.id}" onclick="return confirmx('确认要删除该接口吗？', this.href)"   class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> <spring:message code='global.delete'/></a>
					</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
