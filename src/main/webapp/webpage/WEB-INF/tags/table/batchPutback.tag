...
<button class="btn btn-white btn-sm" onclick="batchPutaway()" data-toggle="tooltip" data-placement="top"><i class="fa fa-trash-o"> ${label==null?'批量下架':label}</i>
                        </button>
	...
	function batchPutaway(){
		...
		// var url = $(this).attr('data-url');
		  ...
		  if(ids == ""){
			...
			top.layer.confirm('确认要批量上架这些商品吗?', {icon: 3, title:'系统提示'}, function(index){
