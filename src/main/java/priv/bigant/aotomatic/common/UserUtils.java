...
import com.tengjie.base.common.sms.SMSUtils;
import com.tengjie.base.common.utils.DataScopeFilterUtils;
import com.tengjie.base.modules.sys.dao.*;
import com.tengjie.base.modules.sys.entity.*;
import com.tengjie.base.modules.sys.security.SystemAuthorizingRealm.Principal;
import com.tengjie.common.utils.CacheUtils;
	...
	public static List<Role> getRoleList(){
		...
		if (roleList == null){
			...
			if (user.isAdmin()){
				...
				Role role = new Role();
				role.getSqlMap().put("dsf", DataScopeFilterUtils.dataScopeFilter(user.getCurrentUser(new UserUtils()), "o", "u"));
	...
	public static List<Office> getOfficeList(){
		...
		if (officeList == null){
			...
			if (user.isAdmin()){
				...
				office.getSqlMap().put("dsf", DataScopeFilterUtils.dataScopeFilter(user.getCurrentUser(new UserUtils()), "a", ""));
